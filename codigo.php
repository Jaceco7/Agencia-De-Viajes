...
//         }#
        ...
        if (isset($_POST['add_btn'])) {
         ...
         if (isset($_POST['add_registro_viaje'])) {
                ...
                //Insertar datos en la tabla viaje ***
                $sql = "INSERT INTO viajes (codigo_Viaje, num_Asientos, costo_Viaje, fecha_Salida,fecha_Regreso, hora_Viaje, cod_Origen, cod_Destino, ced_Viajero)
        ...
        if (isset($_POST['btn_add_reservacion'])) {
         ...
         if (isset($_POST['btn_perfildata'])) {
                ...
                $sql = "UPDATE usuarios SET cedulaUser='$cedulaU', username='$usernombU', password='$contrase', nombre='$nombreU', direccion='$direccionU', telefono='$telefonoU' 
                        WHERE id='$idxUsuario'";
                $consulta =  mysqli_query($conn, $sql);
