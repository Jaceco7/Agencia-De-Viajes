...
<?php
 $connection = mysqli_connect("localhost","root","","bd_agenciaviaje")or die ("No se ha podido conectar al servidor de Base de datos");
     ...
     if (isset($_POST['edit_btn'])) {
         ...
         $query = "SELECT * FROM usuarios WHERE rol_id = 1 AND cedulaUser='$id'";
         ...
         foreach ($query_run as $row) {
            ...
            <form action="../codigo.php" method="POST">
            <input type="hidden" name="edits_id" value="<?php echo $row['cedulaUser'] ?>" >
                    ...
                    <div class="form-group">
                        <label> Cédula</label>
                        <input type="text" name="edit_cedula" value="<?php echo $row['cedulaUser'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Contraseña</label>
