<?php 
    ...
    // Consulta a la tabla 'viajes' para el usuario actual
    ...
    if (mysqli_num_rows($consulta) > 0) {
        ...
        $costosViajar = floatval($registro["costo_Viaje"]);
        $codi_v = $registro["codigo_Viaje"];
    }

    // Calculamos el total
    $seguro = 50;           // Seguro de viajero/equipaje
    $impuestos = 0.08;      // 8%
    $descuento = 0.05;      // 5%

    $subtotal = $costosViajar + $seguro;
    $montoImpuestos = $subtotal * $impuestos;
    $totalConImpuestos = $subtotal + $montoImpuestos;
    $totalViaje = $totalConImpuestos - ($totalConImpuestos * $descuento);
?>
<!DOCTYPE html>
<html lang="es">
            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        ...
                        <span class="text-muted">$ <?php echo number_format($costosViajar, 2); ?></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                        ...
                        <span class="text-muted">$ <?php echo number_format($seguro, 2); ?></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between bg-light lh-condensed">
                        ...
                        <span class="text-muted"><?php echo ($impuestos * 100); ?>%</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between bg-light">
                        ...
                        <span class="text-success"><?php echo ($descuento * 100); ?>%</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Total (USD)</span>
                        <strong class="text-danger">$ <?php echo number_format($totalViaje, 2); ?></strong>
                    </li>
                </ul>
            </div>
